...
module.exports = async (args, msg, Discord) => {
    ...
    if (!amount || isNaN(amount))
        return msg.reply(
            'Please provide a valid integer to decrease the user\'s level by',
        );
    ...
    return msg.channel.send({
        embed: {
            title: 'Sanction!',
            description: `${member}, you have been sanctioned by ${msg.member}. You're now on level ${mmbr.level}. Bad luck!`,
            fields: [
                {
                    name: 'Reason',
                    value: reason,
